...
public class AWalletBottomNavigationView extends LinearLayout
{
    ...
    private final TextView bridgeBrowserLabel;
    ...
    public AWalletBottomNavigationView(Context context, @Nullable AttributeSet attrs)
    {
        ...
        bridgeBrowserLabel = findViewById(R.id.nav_browser_bridge_text);
        ...
        dappBrowserLabel.setOnClickListener(v -> selectItem(TOKEN_SWAP));
        bridgeBrowserLabel.setOnClickListener(v -> selectItem(DAPP_BROWSER ));
    ...
    public void setSelectedItem(WalletPage index)
    {
        ...
        switch (index)
        {
            case TOKEN_SWAP:
                ...
                break;
            case DAPP_BROWSER:
                bridgeBrowserLabel.setSelected(true);
                bridgeBrowserLabel.setTypeface(semiboldTypeface);
                break;
            case WALLET:
    ...
    private void deselectAll()
    {
        ...
        bridgeBrowserLabel.setSelected(false);
        bridgeBrowserLabel.setTypeface(regularTypeface);
    ...
    public void hideBrowserTab()
    {
        ...
        if (bridgeBrowserLabel != null) bridgeBrowserLabel.setVisibility(View.GONE);
    }
