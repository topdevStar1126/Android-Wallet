...
@HiltViewModel
public class BridgeBrowserViewModel extends BaseViewModel implements TransactionSendHandlerInterface
{
    ...
    {
        return BridgeBrowserUtils.getDappsList(context);
    }
