...
public class NewSettingsFragment extends BaseFragment
{
    ...
    private SettingsItemView security;
...
//                        .build();
        ...
        security =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.ic_settings_backup)
                        .withTitle(R.string.security)
                        .withListener(this::onShowSecurity)
                        .build();
    ...
    private void addSettingsToLayout()
    {
        ...
        systemSettingsLayout.addView(security, systemIndex++);
    ...
    private void openShowPrivateKey(Wallet wallet)
    {
        Intent intent = new Intent(getContext(), ShowPrivateKey.class);
        intent.putExtra(WALLET, wallet);
        startActivity(intent);
    }
