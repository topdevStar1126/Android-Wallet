...
import com.alphawallet.app.SwapFragment;
@AndroidEntryPoint
...
//            Timber.e("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX   " + "locked");
//            Intent intent1 = keyguardManager.createConfirmDeviceCredentialIntent("Authentication required", "Please enter your device credentials to continue");
//            if (intent1 != null) {
//                startActivityForResult(intent1, 1);
//            } else {
//                //initializeWallet();
//                Timber.e("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX   " + "disable");
//            }
//        } else {
//            Timber.e("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX   " + "unlocked");
//        }
        sharedPreferencesManager = SharedPreferencesManager.getInstance(this);

        int autolock_time = sharedPreferencesManager.getInt("autolock_time", 0);
        //showToast(String.valueOf(autolock_time));
...
//        }
    ...
    protected void onResume()
    {
        ...
        sharedPreferencesManager = SharedPreferencesManager.getInstance(this);
        int position = sharedPreferencesManager.getInt("home_cur_page", 0);
    ...
    private void showPage(WalletPage page)
    {
        ...
        switch (page)
        {
            ...
            case TOKEN_SWAP:
                ...
                selectNavigationItem(TOKEN_SWAP);
                break;
