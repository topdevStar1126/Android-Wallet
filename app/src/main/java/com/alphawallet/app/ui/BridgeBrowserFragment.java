...
import com.alphawallet.app.util.BridgeBrowserUtils;
import com.alphawallet.app.util.LocaleUtils;
import com.alphawallet.app.util.QRParser;
import com.alphawallet.app.util.Utils;
import com.alphawallet.app.viewmodel.BridgeBrowserViewModel;
...
@AndroidEntryPoint
public class BridgeBrowserFragment extends BaseFragment implements OnSignTransactionListener, OnSignPersonalMessageListener,
        ...
        ActionSheetCallback, TestNetDialog.TestNetDialogCallback
{
    ...
    private BridgeBrowserViewModel viewModel;
    ...
    private void initView(@NotNull View view)
    {
        ...
        if (savedState != null)
        {
            ...
            loadOnInit = (TextUtils.isEmpty(lastUrl) || !lastUrl.startsWith("https://www.synapseprotocol.com")) ? getDefaultDappUrl() : lastUrl;
        }
        else
        {
    ...
    private void initViewModel()
    {
        viewModel = new ViewModelProvider(this)
                .get(BridgeBrowserViewModel.class);
    ...
    public void onWebpageLoaded(String url, String title)
    {
        ...
        if (isValidUrl(url))
        {
            ...
            BridgeBrowserUtils.addToHistory(getContext(), dapp);
    ...
    private String getDefaultDappUrl()
    {
        ...
        return customHome != null ? customHome : BridgeBrowserUtils.defaultDapp(activeNetwork != null ? activeNetwork.chainId : 0);
    }
